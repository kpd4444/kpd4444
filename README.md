...
안녕하세요.  
AI를 잘 활용하지만, AI에만 의존하지 않는 백엔드 개발자 김태민입니다.

AI를 문제 해결의 속도와 깊이를 높이는 도구로 활용하되,  
기술의 원리와 구조를 직접 이해하며 성장하고 있습니다.

Spring Boot와 JPA를 기반으로 서버의 흐름을 구현하고,  
데이터베이스 설계와 배포 환경까지 연결하며 안정적인 서비스를 만드는 경험을 쌓고 있습니다.
